	    	...
	    	<div class="content page-order-payment">
	    	    <div class="gray-box clear">
	    	        ...
	    	        <div class="box-inner payment-checkout-panel clear">
	    	            <span class="jianguo-blue-main-btn big-main-btn js-payment-order" v-if="!orderInfo.isPay" @click="payNow(orderInfo.orderId)">
	    	                <a>现在支付</a>
	    	            </span>
	    	    ...
	    	    <div class="confirm-detail">
	    	        ...
	    	        <p class="info-detail">联系电话：{{orderInfo.receiveInfo.phone}}</p>  <p class="info-detail">详细地址：{{orderInfo.receiveInfo.province}}{{orderInfo.receiveInfo.city}}{{orderInfo.receiveInfo.county}}</p>
	    	    </div>
	    	    <div class="confirm-detail">
